...
<head>
  ...
  <link rel="stylesheet" href="./assets/css/tet.css">
...
<body>
    ...
    <div class="row">
      <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">Danish Naseer</a>
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon "> <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0)">
                  <path d="M6.3682 8.52492H18.72C19.5471 8.52492 20.2364 9.20158 20.2364 10.0134C20.2364 10.8253 19.5471 11.5019 18.72 11.5019H6.34063C5.51349 11.5019 4.82422 10.8253 4.82422 10.0134C4.85179 9.1745 5.51349 8.52492 6.3682 8.52492Z" fill="#FEFEFE" />
                  <path d="M1.54397 0H18.7207C19.5478 0 20.2372 0.67659 20.2372 1.4885C20.2372 2.30041 19.5478 2.97699 18.7207 2.97699H1.51641C0.689276 2.97699 0 2.30041 0 1.4885C0.0275723 0.67659 0.689276 0 1.54397 0Z" fill="white" />
                  <path d="M1.54397 17.023H18.7207C19.5478 17.023 20.2372 17.6996 20.2372 18.5115C20.2372 19.3234 19.5478 20 18.7207 20H1.51641C0.689276 20 0 19.3234 0 18.5115C0.0275723 17.6996 0.689276 17.023 1.54397 17.023Z" fill="white" />
                </g>
                <defs>
                  <clipPath id="clip0">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
        <div id="fullheader" class="fullheader" data-scroll-index="0">
          ...
          <div id="header">
            <div class="container mt-200 half-mt mb-25">
              <div class="head-info">
                <div class="header-content ">
                  <span class="subtitle fz-24">Hi, I am <br></span>
                  <span id="typed-slide-1" class="h1 textfull"></span>
                </div>
                <div class="text">
                  <span class="subtitle fz-24 mt-9 pb-35">Frontend Developer <br></span>
                  <button class="btn btn-success me-2 mt-5">Download CV</button>
                  <button class="btn btn-outline-success mt-5 btn-white">Read more</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <!-- type js end -->
      <div class="col-lg-6 col-md-6 col-sm-6">
        <img src="./assets/images/img.png" alt="" class="w-100 h-auto">
      </div>
    </div>
  </div>
  <div class="container-xl">
    <div class="row">
      ...
      <div class="container text-center">
        <h2>About</h2>
        <div class="row">
          <p class="col-2 offset"></p>
          <p class="col-8">I'm Danish Naseer and I'm a hardworking and ambitious individual with a great passion for Technology. I am Recently graduated in BS Computer science at Lahore Garrison University. I have excellent communication skills, enabling me to effectively communicate with a wide range of people. I am looking for a position in the industry in which I can put into practice my knowledge and experience, ultimately benefiting the operations of the organization that I work for. </p>
          <p class="col-2 offset"></p>
        </div>
      </div>
    </div>
    ...
    <div class="row mt-40">
      <div class="col-sm-3">
        <div class="circle-dot text-center">
          <div class="dot">
          ...
          <div class="text mt-2">
            <h3 class="fz-18"> Danish Naseer</h3>
      ...
      <div class="col-sm-3">
        <div class="circle-dot text-center">
          ...
          <div class="text mt-2">
            <h3 class="fz-18"> Email</h3>
            <p>Danishnaseerktk@gmail.com</p>
          </div>
        </div>
      </div>
      <!--  -->
      <div class="col-sm-3">
        <div class="circle-dot text-center">
          ...
          <div class="text mt-2">
            <h3 class="fz-18">Linkedin</h3>
            <p>realdanishnaseer</p>
          </div>
        </div>
      </div>
      <!--  -->
      <div class="col-sm-3">
        <div class="circle-dot text-center">
          ...
          <div class="text mt-2">
            <h3 class="fz-18">Phone number</h3>
            <p>+923470957473</p>
          </div>
        </div>
      </div>
    ...
    <div class="row mt-40 mb-40">
      ...
      <div class="col-sm-3 mr-26">
        <div class="card text-white fromleft ">
          <div class="card-header"><svg width="57" height="47" viewBox="0 0 57 47" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="col-sm-3 mr-26">
        <div class="card text-white">
          <div class="card-header"><svg width="51" height="47" viewBox="0 0 51 47" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="contact-wrapper mb-40">
    ...
    <form id="contact-form" class="form-horizontal" role="form" style="margin-right: 12px
    ;">
